...
from src.multi_agent_mobile_ui_assistant.config.llm import LLMConfig, create_llm, get_default_llm
...
class TestLLMConfig:
    ...
    @patch("src.multi_agent_mobile_ui_assistant.config.llm.ChatOllama")
    ...
    @patch("src.multi_agent_mobile_ui_assistant.config.llm.ChatOpenAI")
...
class TestCreateLLM:
    ...
    @patch("src.multi_agent_mobile_ui_assistant.config.llm.LLMConfig")
...
class TestGetDefaultLLM:
    ...
    def setup_method(self):
        ...
        import src.multi_agent_mobile_ui_assistant.config.llm as module
        module._default_llm = None

    @patch("src.multi_agent_mobile_ui_assistant.config.llm.create_llm")
